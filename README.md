## A) Loops in Python: Palindrome Number Checker
...
# B) Built-in Functions -Binary Conversion Using Built-in Functions in Python
...
# D) Functions in Python: Modulo Calculator
...
# E) Looping(Patterns)-Pascal's Triangle Generator in Python
